...
export const sector: MacroSector = {
  group: {
      ...
      intro:
        "원유·구리·천연가스는 거의 모든 물건의 원가에 들어갑니다. 값이 오르면 시차를 두고 물가로 옮겨붙고, 기업의 이익률을 깎습니다. 구리는 쓰임새가 워낙 넓어 '경기 박사(Dr. Copper)'라고 불릴 만큼 경기를 앞서 보여줍니다. 금리가 오르면 원자재는 네 갈래로 눌립니다 — 재고를 이고 있는 비용이 커지고, 지금 파는 편이 유리해져 공급이 앞당겨지고, 투기자금이 단기국채로 옮겨가고, 달러가 오르면서 다른 나라의 구매력 기준 가격이 비싸집니다. ⚠ 다만 이 관계는 **시대에 따라 달라집니다** — 1980년대 이후 자료만으로는 잘 확인되지 않는다는 것이 이 설명을 처음 세운 연구자(프랭클) 본인의 말입니다. 국면을 읽는 데 쓰되 상수처럼 쓰지 마세요.",
      order: 6,
    },
  indicators: [
    {
