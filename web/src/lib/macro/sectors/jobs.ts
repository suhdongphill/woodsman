...
export const sector: MacroSector = {
  ...
  indicators: [
    ...
    {
      // 달러/시간 수준 계열(월간·계절조정). 전년비는 읽을 때 계산한다.
      key: "wages_yoy",
      name: "평균 시간당 임금 (전년비)",
      group: "jobs",
      source: "FRED",
      ...
      unit: "%",
      decimals: 1,
      url: FRED("CES0500000003"),
      sourceLabel: "FRED · CES0500000003 (원 발표: 미 노동통계국 BLS 고용상황)",
      what: "민간 부문 근로자가 한 시간 일하고 받는 평균 임금이 1년 전보다 얼마나 올랐는지입니다.",
      why: "임금은 물가의 가장 끈질긴 원천입니다. 서비스 가격은 대부분 인건비라, 임금이 빠르게 오르면 물가가 쉽게 내려오지 않습니다. 명세 Engine Heat의 「Wage Pressure」 자리입니다.",
      read: "⚠ **생산성과 함께 보세요.** 임금이 4% 오르고 생산성이 2% 오르면 인건비 압력은 2% 남짓입니다(단위노동비용). 임금만 보고 인플레이션을 단정하지 않습니다. 명목 임금이 물가보다 빠른지는 실질 시간당 보수가 따로 보여 줍니다.",
      order: 6,
    },
  ],
};
