...
const ETFS: EtfSpec[] = [
  ...
  },
  {
    ...
    symbol: "SMH",
    /**
     * ⚠ 2026-09-07 이름 정정. 「반도체」라고만 적어 두니 글에서 **SOX(필라델피아 반도체지수)**
     * 를 인용할 때 독자가 이 카드에서 확인하려다 값이 안 맞았다. SMH는 ETF 가격(백 단위)이고
     * SOX는 지수(만 단위)라 자릿수부터 다르다. **계열이 무엇인지 이름에 적는다.**
     */
    name: "반도체 (SMH)",
    what: "반도체 설계·제조 기업을 담은 ETF입니다. ⚠ 지수 SOX(필라델피아 반도체지수)가 아니라 ETF 가격이라, SOX 수치와는 자릿수부터 다릅니다.",
    why: "한국 증시와 가장 함께 움직이는 계열입니다. 사이클의 앞머리에 섭니다.",
    read: "반도체가 기술 전체보다 앞서면 사이클이 살아 있다는 뜻입니다. ⚠ 지수 SOX는 반도체 묶음(/macro/semi#sox)에 따로 있습니다 — 글에서 SOX를 인용한다면 그쪽 값입니다.",
  },
  {
    key: "sector_fin",
    symbol: "XLF",
