...
export const sector: MacroSector = {
  ...
  indicators: [
    ...
    {
      // 지수(1998-12=100) 수준 계열(월간·계절조정 안 됨). ⚠ 품질 조정 때문에 지수는 장기적으로 계속 내려간다(2026-08 약 28.5).
      key: "semi_ppi_yoy",
      name: "반도체 생산자물가 (전년비)",
      group: "semi",
      source: "FRED",
      sourceId: "PCU334413334413",
      transform: "yoy",
      layer: "L2",
      type: "change",
      freq: "m",
      unit: "%",
      decimals: 1,
      url: FRED("PCU334413334413"),
      sourceLabel: "FRED · PCU334413334413 (원 발표: 미 노동통계국 BLS 생산자물가)",
      what: "미국에서 만든 반도체·관련 소자의 공장 출하 가격이 1년 전보다 얼마나 변했는지입니다.",
      why: "AI 설비 수요가 공급을 앞지르면 칩과 장비 가격이 먼저 오릅니다. 명세 AI Demand의 「AI Equipment Price Pressure」 자리입니다.",
      read: "⚠ **이 지수는 원래 내려가는 지수입니다** — 같은 값에 성능이 좋아지면 가격이 내린 것으로 계산하기 때문입니다. 그래서 마이너스 자체는 이상하지 않습니다. **하락 폭이 줄거나 플러스로 돌아서는 것**이 가격 압력의 신호입니다. ⚠ 미국 내 생산분이라 대만·한국산 칩 가격은 직접 들어 있지 않습니다.",
      order: 9,
    },
  ],
};
