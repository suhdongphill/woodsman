    ...
    return (
      ...
      >
        <div className="min-w-0">
          ...
          <h3 className="mt-1.5 text-[15px] font-semibold text-white transition-colors group-hover:text-gold-400">
            {headline ?? "티스토리 블로그에서 더 깊게 읽기"}
          </h3>
    ...
    >
      <div className="p-6 sm:p-7">
        ...
        <h2 className="mt-2 text-lg font-bold leading-snug text-white sm:text-xl">
          {headline ?? "이 주제를 더 길게 다룬 글이 블로그에 있습니다"}
        </h2>
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="mt-5 inline-flex items-center gap-2 rounded-xl bg-gold-500 px-5 py-3 text-sm font-semibold text-[#1a1400] transition-colors hover:bg-gold-400"
        >
          블로그에서 이어 읽기
          <ExternalIcon size={15} />
        </a>

        <p className="mt-3 font-mono text-[11.5px] text-gray-500">
          {displayUrl(TISTORY_FEATURED_URL)}
        </p>
      </div>
    </aside>
