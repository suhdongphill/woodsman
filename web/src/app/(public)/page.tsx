 ...
 * 그래서 가입 유도 퍼널을 두지 않고, 첫 화면이 **지금 무슨 바람이 부는지**로 열린다.
 *
 * ⚠ 2026-08-31(재편 완료): 전에 이 주석은 "첫 화면에서 바로 넣은 돈이 얼마가 됐는지를
 *    보여준다"고 적혀 있었다. **더는 사실이 아니다** — 계좌는 콘텐츠를 읽은 뒤의
 *    한 줄 띠이고, 상세는 `/portfolio`에 있다. 계좌는 입구가 아니라 **증거**다.
 *    (남의 계좌 평가액을 검색하는 사람은 없고, 1순위 목적은 블로그로 넘기는 것이다.)
 *
